...
- **Analytics** (`/admin-portal/analytics`, admin-only, ungated core): same money rules + CSV/PDF export; weekly buckets use the same business-TZ Mondays as invoices/payroll (the old analytics-vs-invoice week divergence is gone).
