  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "boolean",
        hiddenInGrid: true,
        helpText: "When enabled, the configured tax rate is applied to this site's invoices automatically.",
      },
      {
        key: "salesTaxRate",
        ...
        hiddenInGrid: true,
        placeholder: "8.25",
        helpText: "Percentage applied to the invoice subtotal when sales tax is enabled (e.g. 8.25 for 8.25%).",
      },
      { key: "notes", label: "Notes", type: "textarea", hiddenInGrid: true },
      { key: "createdAt", label: "Created", type: "datetime", readonly: true },
    ],
