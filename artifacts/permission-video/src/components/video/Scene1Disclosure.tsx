...
export const Scene1Disclosure = () => {
  ...
  return (
    <motion.div
      className="absolute inset-0 bg-[#0c0a08] flex flex-col pt-12 px-5 pb-6 z-10"
      initial={{ opacity: 0 }}
    ...
    >
      <motion.div 
        ...
        className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#C9A84C] to-[#91762e] flex items-center justify-center mb-4 mx-auto shadow-[0_0_30px_rgba(201,168,76,0.3)]"
      >
      ...
      <motion.div
        ...
        className="space-y-3 text-[13px] leading-snug text-zinc-300 flex-1"
      >
        <p>
        ...
        <div className="p-3 rounded-xl bg-zinc-900/50 border border-zinc-800/50 flex gap-3 mt-4">
        ...
        <div className="p-3 rounded-xl bg-zinc-900/50 border border-zinc-800/50 flex gap-3 mt-3">
      ...
      >
        <motion.div
          ...
          className="w-full bg-[#C9A84C] text-black font-bold py-3 rounded-xl text-center text-base"
        >
          I agree, continue
        </motion.div>
        {/* Play requires a real decline path, not just an acknowledgement. */}
        <div className="w-full py-2.5 text-center text-zinc-400 font-semibold text-sm">
          Not now
        </div>
      </motion.div>
